    ...
    def generate_newsletter(self, preview=False):
        ...
        if '<!-- FOOTER MESSAGE - DO NOT REMOVE -->' in newsletter_rendered:
            newsletter_rendered = newsletter_rendered.replace(
	            ...
	            ' I can receive donations using PayPal at <a href="https://paypal.me/nkruiper" target="_blank" '
	            'style="text-decoration: underline;color: inherit;font-size: inherit;">paypal.me/nkruiper</a>'
	            ', with Interac e-Transfer at <a href="mailto:nkruiper@gmail.com">nkruiper@gmail.com</a>, or with a cryptocurrency of your choice.'
            )
...
#            base_url = helpers.get_plexpy_url() + '/newsletter/'
        base_url = 'https://newsletter.noahflix.shazbot.ca/'
